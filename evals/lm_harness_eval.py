...
class MambaEvalWrapper(HFLM):
    ...
    def __init__(self, pretrained="state-spaces/mamba-2.8b", max_length=2048, batch_size=None, device="cuda", dtype=torch.float16, debug=False, sparsedB=False, sparsehs=False, fastexp=False, silu=False, predict=False, predictB=False):
        LM.__init__(self)
        marca_args_dict = {"debug":debug, "sparsedB":sparsedB, "sparsehs":sparsehs, "fastexp":fastexp, "silu":silu, "predict":predict, "predictB":predictB}
